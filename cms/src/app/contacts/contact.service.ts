...
export class ContactService {
  ...
  getContacts(){
    this.http.get<Contact[]>('https://wdd430her-ff6e9-default-rtdb.firebaseio.com/contacts.json')
  ...
  storeContacts(){
    ...
    this.http.put<Contact[]>('https://wdd430her-ff6e9-default-rtdb.firebaseio.com/contacts.json',
    this.contacts)
    .subscribe( {
