...
export class MessageService {
  ...
  getMessages(){
    this.http.get<Message[]>('https://wdd430her-ff6e9-default-rtdb.firebaseio.com/messages.json')
  ...
  storeMessages(){
    ...
    this.http.put<Message[]>('https://wdd430her-ff6e9-default-rtdb.firebaseio.com/messages.json',
    this.messages)
    .subscribe( {
